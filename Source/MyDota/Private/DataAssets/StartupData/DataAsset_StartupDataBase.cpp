...
void UDataAsset_StartupDataBase::GrandAbilities(const TArray<TSubclassOf<UGameplayAbility>>& InAbilitiesToGive, UMD_AbilitySystemComponent* InASCToGive, int32 ApplyLevel)
{
