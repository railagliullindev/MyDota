...
UGA_AttackBase::UGA_AttackBase(const FObjectInitializer& Initializer)
	: Super(Initializer)
{
...
void UGA_AttackBase::PlayAttackMontage()
{
	...
	UAbilityTask_WaitGameplayEvent* WaitEventTask = UAbilityTask_WaitGameplayEvent::WaitGameplayEvent(this, MyDotaTags::Event_Montage_Hit, nullptr, true, false);
	...
	UAbilityTask_PlayMontageAndWait* MontageTask = UAbilityTask_PlayMontageAndWait::CreatePlayMontageAndWaitProxy(this, NAME_None, AttackMontage, PlayRate);
